...
Please use the data structure column analysis information generated in the above \
historical dialogue to answer the user's questions through duckdb sql data analysis \
under the following constraints..

Constraint:
    1.Please fully understand the user's problem and use duckdb sql for analysis. The \
    analysis content is returned in the output format required below. Please output \
    the sql in the corresponding sql parameter.
    2.Please choose the best one from the display methods given below for data \
    ...
    3.The table name that needs to be used in SQL is: {table_name}. Please check the \
    sql you generated and do not use column names that are not in the data structure.
    4.Give priority to answering using data analysis. If the user's question does not \
    involve data analysis, you can answer according to your understanding.
    5.The sql part of the output content is converted to: \
